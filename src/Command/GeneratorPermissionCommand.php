...
class GeneratorPermissionCommand extends GeneratorCommand
{
  ...
  protected function configure()
  {
    $this
      ...
      ->addOption('permissions','',InputOption::VALUE_OPTIONAL, $this->trans('commands.common.options.permissions'))
    ;
  }
...
//      $permissions = $dialog->ask($output,
//        $dialog->getQuestion($this->trans('commands.generate.permission.options.permission'), 'Access Content'),
//        'access content'
//      );
//      $permissions = $this->getStringUtils()->camelCaseToLowerCase($permissions);
