...
class DatabaseDumpCommand extends ContainerAwareCommand {
  ...
  function __construct($translator) {
    ...
    if ($connection->databaseType() !== 'mysql') {
      throw new \RuntimeException($translator->trans('commands.database.dump.messages.not_mysql'));
    }
  ...
  protected function configure() {
    $this->setName('database:dump')
      ...
      ->addOption('file', NULL, InputOption::VALUE_OPTIONAL, $this->trans('commands.database.dump.options.file'), 'none')
      ;
  }
  ...
  protected function execute(InputInterface $input, OutputInterface $output) {
    ...
    if($file == 'none'){
      ...
      $output->writeln(str_replace('%file', $file, $this->trans('commands.database.dump.messages.file_written')));
    }
  }
