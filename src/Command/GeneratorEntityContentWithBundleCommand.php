...
class GeneratorEntityContentWithBundleCommand extends GeneratorEntityCommand
{
    protected function configure()
    {
        ...
        $this->addOption(
          ...
          $this->trans('commands.generate.entity.options.bundle')
        );
  ...
  protected function interact(InputInterface $input, OutputInterface $output) {
    ...
    $default_bundle = $utils->camelCaseToHuman($entity_class);
    ...
    if (!$bundle) {
      $bundle = $dialog->ask(
        $output,
        $dialog->getQuestion($this->trans('commands.generate.entity.questions.bundle'), $default_bundle),
        $default_bundle
      );
    }
