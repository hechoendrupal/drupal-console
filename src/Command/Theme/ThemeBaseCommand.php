...
class ThemeBaseCommand extends Command
{
    ...
    /**
     * Gets the theme from input by request input from a user.
     *
     * @param string $title
     *   Title before the input.
     * @param string $question
     *   Request to a user for input of a new theme.
     * @param array  $theme_list
     *   List of the themes for autocomplete.
     */
