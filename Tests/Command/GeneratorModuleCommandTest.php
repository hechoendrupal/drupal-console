...
class GeneratorModuleCommandTest extends GenerateCommandTest
{
  ...
  {
    list($module, $dir, $description, $core, $package, $controller, $tests, $structure) = $expected;
    ...
    $generator
      ->expects($this->once())
      ->method('generate')
      ->with($module, $dir, $description, $core, $package, $controller, $tests, $structure)
    ;
  ...
  public function getInteractiveData()
  {
    ...
    return [
      ...
      [
        [],
        ['foo', $dir, 'My Awesome Module', '8.x', 'Other', false, true, true],
        "foo\n$dir\n"
      ],
    ];
  }
  ...
  public function getNoInteractiveData()
  {
    ...
    return [
      [
        ['--module'=>'bar','--module-path'=>$dir, '--description'=>'My Awesome Module','--core'=>'8.x','--package'=>'Other', '--controller'=>true,'--tests'=>true,'--structure'=>true],
        ['bar', $dir, "My Awesome Module", '8.x', 'Other', true, true, true],
      ],
      [
        ['--module'=>'bar','--module-path'=>$dir,'--description'=>'My Awesome Module','--core'=>'8.x','--package'=>'Other', '--controller'=>true,'--tests'=>true,'--structure'=>true],
        ['bar', $dir, "My Awesome Module", '8.x', 'Other', true, true, true],
